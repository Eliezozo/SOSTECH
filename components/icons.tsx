...
export const IpPhoneIcon = (p: IconProps) => (
  <svg {...base(p)}>
...
/** Home service icons in dictionary order. */
export const homeServiceIcons = [CameraIcon, BellIcon, LockIcon, EyeIcon];

/** Full services page icons in dictionary order (10 services). */
